...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['team-lead', 'employee', 'administrator', 'hr-manager', 'owner'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Folder', path: '/folders', entity: 'folder', service: AccessServiceEnum.PROJECT, icon: FiFolder },
    {
      name: 'Interaction',
      path: '/interactions',
      entity: 'interaction',
    ...
    { name: 'Tag', path: '/tags', entity: 'tag', service: AccessServiceEnum.PROJECT, icon: FiTag },
